...
const monstersTypes = require("./src/types/monstersTypes");
const npcs = require("./src/lists/npcs").npcs;
const dbConnect = require("./src/dbconnect");
const dbc = new dbConnect();
const inGameMonsters = require("./src/lists/monstersList").data;
const game = require("./public/js/gameDetails");
const public = require("./js/public");
const itemsList = require("./src/lists/itemsList").list;
